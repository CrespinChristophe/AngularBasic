...
@NgModule({
  declarations: [  
    ChronoComponent, Exo1Component, ExoComponent, ExoDirectivesComponent, ExoCommuComponent, ExoCommuChildrenComponent, ExoParentComponent, ExoEnfantComponent, ExoEnfantDeuxComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
